...
`kvtool kava -- tx greet create-greeting "hello world from kava chain" --from whale --fees 200ukava` \* If you get an error about `fees; got: required: 200ukava: insufficient fee`, update the `fees` to the required amount
