...
- Kava's official API endpoint is https://api.data.kava.io.
...
![Binance Chain to Kava Diagram](../../../../static/img/diagrams/BEP3_binance_chain_to_kava.jpg)
...
![Kava to Binance Chain Diagram](../../../../static/img/diagrams/BEP3_kava_to_binance_chain.jpg)
