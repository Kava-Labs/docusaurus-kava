...
After creating a private endpoint, you can secure it by adding API keys and applying Domain (Cross-Origin) and IP Address whitelists for frontend access.

**Step 3: Test your private Kava endpoint**
...
"https://lb.nodies.app/v1/<INSERT URL>"
```
