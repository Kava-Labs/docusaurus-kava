...
execution environments with seamless interoperability between the two. The following diagram shows how the system will function once the Kava 10 upgrade is complete and 
the Kava Network mainnet goes live. More information about Kava 10 (Kava Network 1.0) can be found `here`. // add link 
