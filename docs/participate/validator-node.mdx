...
At line 212, add [seeds](https://docs.google.com/spreadsheets/d/1s3LXLPFJazzdmwKdRv909pe_-ZV_Xbt2uCCNrhoOyIE/edit#gid=0). These are used to connect to the peer-to-peer network:

At line 215, add some [persistent peers](https://docs.google.com/spreadsheets/d/1s3LXLPFJazzdmwKdRv909pe_-ZV_Xbt2uCCNrhoOyIE/edit#gid=0), which help maintain a connection to the peer-to-peer network
