...
- Go to [Quicksync](https://quicksync.io/networks/kava.html) and download the .tar pruned file
...
- Go to [Quicksync](https://quicksync.io/networks/kava.html) and download the archive .tar archive file to be used (please note that you should only download this file once)
